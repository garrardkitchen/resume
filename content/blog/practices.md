...
Logging, metrics and tracing.  You'll see many references to observability here and across everything I post.  It's been a huge part of my working life for as far back as I can remember.  For your business to survive, you must capture pertinent information.  This will inform on how well your system(s) are performing well and how to discover reaons(s) why it might not be. Without this, your engineers will have zero visibility and establishing where to start looking is a case of fumbling around int the dark.  Not to mention the latency this induces when there is either no or little substance to your observabiliity strategy.
...
As Fargate was a containerization service, I was able to capture logging, metrics and trace information by utilisation of a sidecar pattern and include a Datadog container with each Task.

Lamba, on the other hand was a different kettle of fish.  I spent months in weekly meetings with Datadog, reporting on progress and doing my utmost to convince them they needed a serverless solution. Eventually they released Cloud Functions.  It's a nice solution and it fits well with their realestate.  I was included on their preview programme for Cloud Functions and broke the news of their immenent release.
